...
export const ChatPage = (): JSX.Element => {
  ...
  return (
    <div className="flex h-full justify-end sm:justify-start items-start">
      {/* いろんな人とのやりとりリスト */}
      <div className="hidden sm:flex sm:w-[24%] flex flex-col overflow-y-auto border-r-gray-700">
